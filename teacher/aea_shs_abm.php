      ...
      <li class="nav-item has-treeview menu-open">
        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../teacher/aea_shs_abm.php?username='.$_GET['username'].'" class="nav-link active">
              ...
              <div class="card card-primary card-outline card-outline-tabs">
                <div class="card-header p-0 border-bottom-0">
                  <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#custom-content-below-home" role="tab" aria-controls="custom-content-below-home" aria-selected="true">1st Semester 1st Quarter</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#custom-content-below-profile" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">1st Semester 2nd Quarter</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="custom-content-below-messages-tab" data-toggle="pill" href="#custom-content-below-messages" role="tab" aria-controls="custom-content-below-messages" aria-selected="false">2nd Semester 3rd Quarter</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="custom-content-below-settings-tab" data-toggle="pill" href="#custom-content-below-settings" role="tab" aria-controls="custom-content-below-settings" aria-selected="false">2nd Semester 4th Quarter</a>
                    </li>
                    <li class="nav-item">
...
<script>
  ...
  $(document).ready(function(){
      $.ajax({
          type: "GET",
          url: "../teacher/api/read_subjects_shs_1.php?section=<?php echo $_SESSION['adviser1']; ?>",
          dataType: 'json',
          success: function(data) {
  ...
  $(document).ready(function(){
      $.ajax({
          type: "GET",
          url: "../teacher/api/read_subjects_shs_2.php?section=<?php echo $_SESSION['adviser1']; ?>",
          dataType: 'json',
          success: function(data) {
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../teacher/api/read_aea_q1_shs.php?section=<?php echo $_SESSION["adviser1"]; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="1" && data[user].subject=="Final") {
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="1" && data[user].subject=="Final") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="1" && data[user].subject=="Final") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="1" && data[user].subject=="sub1") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="1" && data[user].subject=="sub1") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="1" && data[user].subject=="sub1") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="1" && data[user].subject=="sub2") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="1" && data[user].subject=="sub2") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="1" && data[user].subject=="sub2") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="1" && data[user].subject=="sub3") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="1" && data[user].subject=="sub3") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="1" && data[user].subject=="sub3") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="1" && data[user].subject=="sub4") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="1" && data[user].subject=="sub4") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="1" && data[user].subject=="sub4") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="1" && data[user].subject=="sub5") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="1" && data[user].subject=="sub5") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="1" && data[user].subject=="sub5") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="1" && data[user].subject=="sub6") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="1" && data[user].subject=="sub6") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="1" && data[user].subject=="sub6") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="1" && data[user].subject=="sub7") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="1" && data[user].subject=="sub7") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="1" && data[user].subject=="sub7") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="1" && data[user].subject=="sub8") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="1" && data[user].subject=="sub8") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="1" && data[user].subject=="sub8") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="1" && data[user].subject=="sub9") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="1" && data[user].subject=="sub9") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="1" && data[user].subject=="sub9") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="1" && data[user].subject=="sub10") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="1" && data[user].subject=="sub10") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="1" && data[user].subject=="sub10") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../teacher/api/read_aea_q2_shs.php?section=<?php echo $_SESSION["adviser1"]; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../teacher/api/read_aea_q3_shs.php?section=<?php echo $_SESSION["adviser1"]; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="2" && data[user].subject=="Final") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="2" && data[user].subject=="Final") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="2" && data[user].subject=="Final") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="2" && data[user].subject=="sub1") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="2" && data[user].subject=="sub1") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="2" && data[user].subject=="sub1") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="2" && data[user].subject=="sub2") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="2" && data[user].subject=="sub2") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="2" && data[user].subject=="sub2") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="2" && data[user].subject=="sub3") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="2" && data[user].subject=="sub3") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="2" && data[user].subject=="sub3") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="2" && data[user].subject=="sub4") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="2" && data[user].subject=="sub4") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="2" && data[user].subject=="sub4") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="2" && data[user].subject=="sub5") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="2" && data[user].subject=="sub5") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="2" && data[user].subject=="sub5") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="2" && data[user].subject=="sub6") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="2" && data[user].subject=="sub6") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="2" && data[user].subject=="sub6") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="2" && data[user].subject=="sub7") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="2" && data[user].subject=="sub7") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="2" && data[user].subject=="sub7") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="2" && data[user].subject=="sub8") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="2" && data[user].subject=="sub8") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="2" && data[user].subject=="sub8") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="2" && data[user].subject=="sub9") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="2" && data[user].subject=="sub9") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="2" && data[user].subject=="sub9") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Highest Honors" && data[user].sem=="2" && data[user].subject=="sub10") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With High Honors" && data[user].sem=="2" && data[user].subject=="sub10") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(data) {
            var response="";
            for(var user in data){
                if (data[user].award=="With Honors" && data[user].sem=="2" && data[user].subject=="sub10") {
                  response += "<tr><td><center>"+data[user].last_name+", "+data[user].first_name+"</center></td></tr>";}
            }
