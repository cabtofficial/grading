<?php
  ...
  <nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      <li class="nav-item">
        <a href="../student/index_jhs.php?username='.$_GET['username'].'" class="nav-link">
...
<script>
  $(document).ready(function(){
    ...
    $.ajax({
        type: "GET",
        url: "../student/api/read_grades_hs.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
  ...
  $(document).ready(function(){
        $.ajax({
            type: "GET",
            url: "../student/api/read_final_grade.php?username=<?php echo $_GET['username']; ?>",
            dataType: 'json',
            success: function(data) {
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../student/api/read_deportment1_elem.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
                response += "<tr>"+
                //"<td>"+data[user].user_id+"</td>"+
                '<td style="width:50%;padding:5px 0px;">'+data[user].value+"</td>"+
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../student/api/read_deportment2_elem.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../student/api/read_deportment3_elem.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../student/api/read_deportment4_elem.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
