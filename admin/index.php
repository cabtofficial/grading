<?php
  ...
  <nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
      <li class="nav-item">
        <a href="../admin/index.php?username='.$_GET['username'].'" class="nav-link active">
          ...
          <div class="card">
            <div class="card-header p-2">
              <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link" href="#sched" data-toggle="tab">Calendar</a></li>
               </ul>
            </div> <!-- /.card-header -->
            <div class="card-body">
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      events    : [
        {
          title          : 'Holy Week and Cavite is under ECQ--- NO CLASSES',
          description    : 'Holy Week and Cavite is under ECQ--- NO CLASSES',
          start          : new Date(2021, 3 - 1, 29),
          end            : new Date(2021, 4 - 1, 4 + 1),
          allDay         : true,
        ...
        {
          title          : 'Easter Sunday',
          start          : new Date(2021, 4 - 1, 4),
          allDay         : true,
          backgroundColor: '#00a65a', //Success (green)
          borderColor    : '#00a65a' //Success (green)
        },
        {
          title          : 'Resumption of Online classes',
          start          : new Date(2021, 4 - 1, 5),
          allDay         : true,
          //url            : 'http://google.com/',
        ...
        {
          title          : 'Araw ng Kagitingan (Regular Non-working Holiday)',
          start          : new Date(2021, 4 - 1, 9),
          allDay         : true,
          backgroundColor: '#f56954', //red
          borderColor    : '#f56954' //red
        },
        {
          title          : '4th Quarter Long Test',
          start          : new Date(2021, 4 - 1, 14),
          end          : new Date(2021, 4 - 1, 16 + 1),
          allDay         : true,
          backgroundColor: '#f39c12', //yellow
          borderColor    : '#f39c12' //yellow
        },
        {
          ...
          start          : new Date(2021, 4 - 1, 28),
          end          : new Date(2021, 4 - 1, 30 + 1),
          allDay         : true,
          backgroundColor: '#0073b7', //Blue
          borderColor    : '#0073b7' //Blue
        }
