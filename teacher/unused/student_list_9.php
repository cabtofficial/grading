<?php
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li>
      <a href="../teacher/index_9.php?username='.$_GET['username'].'">
    ...
    <li class="treeview active">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="../teacher/student_list_9.php?username='.$_GET['username'].'"><i class="fa fa-circle-o"></i> Class Grades</a></li>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for(var user in data){
                ...
                "<td style='width:5%;font-size:14px;border: 2px solid black;text-align:center;'><a href='../teacher/index_jhs_9.php?username=<?php echo $_GET['username']; ?>&user_id="+data[user].student_num+"'>View Card</a>"+
                "</tr>";
            }
