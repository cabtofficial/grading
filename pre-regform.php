            ...
            <form action="" method="post">
              <div class="card">
                ...
                <div class="card-body bg-gray">
                  <div class="row">
                    <div class="col-md-3">
                      <div class="card card-outline shadow sticky-top">
                        <div class="card-body">
                          <div class="nav flex-column nav-pills me-3" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link active" id="vert-tabs-1-tab" data-toggle="pill" href="#vert-tabs-1" role="tab" aria-controls="vert-tabs-1" aria-selected="true">Home</a>
                            <a class="nav-link" id="vert-tabs-2-tab" data-toggle="pill" href="#vert-tabs-2" role="tab" aria-controls="vert-tabs-2" aria-selected="false">Data Privacy Agreement</a>
                            <a class="nav-link" id="vert-tabs-3-tab" data-toggle="pill" href="#vert-tabs-3" role="tab" aria-controls="vert-tabs-3" aria-selected="false">Learner Information</a>
                            <a class="nav-link" id="vert-tabs-4-tab" data-toggle="pill" href="#vert-tabs-4" role="tab" aria-controls="vert-tabs-4" aria-selected="false">Parent/Guardian Information</a>
                            <a class="nav-link" id="vert-tabs-5-tab" data-toggle="pill" href="#vert-tabs-5" role="tab" aria-controls="vert-tabs-5" aria-selected="false">Emergency Contact Information</a>
                            <a class="nav-link" id="vert-tabs-6-tab" data-toggle="pill" href="#vert-tabs-6" role="tab" aria-controls="vert-tabs-5" aria-selected="false">Payment of Fees</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-9">
                      <div class="tab-content" id="vert-tabs-tabContent" width="500" height="500">
                        <div class="tab-pane text-left fade show active" id="vert-tabs-1" role="tabpanel" aria-labelledby="vert-tabs-1-tab">
                          <div class="card card-outline shadow border border-secondary text-dark">
                            <div class="card-header bg-purple">
                              <h3>awjfliajwljflaigaWelcome to the Online Pre-Registration of the <br>Centennial Academy of the Blessed Trinity for AY 2020-2021</h3>
                            </div>
                            <div class="card-body">
                              <p class="lead">Kindly  fill out this Online Pre-Registration Form with the correct and latest information regarding your child's enrollment to pre-register for AY 2020-2021. You may coordinate with the Accounting Office to settle your previous accounts and enrollment fee to be enrolled officially.</p>
                              <p class="lead">Before proceeding, please read the Online Pre-Registration Instructions and the Enrollment Requirements.</p></hr>
                            </div>
                          </div>
                          <div class="card card-outline shadow border border-secondary text-dark">
                            <div class="card-header bg-purple">
                              <h3>Online Pre-Registration Instructions</h3>
                            </div>
                            <div class="card-body">
                              <ol class="lead">
                                <li>Read the items carefully and fill in all applicable spaces accurately. Type N/A for items that are not applicable.</li>
                                <li>Accomplish and submit one pre-registration form per child.</li>
                                <li>Contact the Accounting Office after submitting this form to be guided on how to settle your enrollment fees.</li>
                              </ol>
                            </div>
                            <div class="card-footer">
                              <p class="lead">A LEARNER IS OFFICIALLY ENROLLED UPON PAYMENT OF FEES AND ISSUANCE OF THE REGISTRATION FORM.</p></hr>
                            </div>
                          </div>
                          <div class="card card-outline shadow border border-secondary text-dark">
                            <div class="card-header bg-purple">
                              <h3>Enrollment Requirements for NEW Learners</h3>
                            </div>
                            <div class="card-body">
                              <ol class="lead">
                                <li>
                                  Nursery – 4 years old by October 31, 2021 <br>
                                  Kindergarten – 5 years old by October 31, 2021
                                </li> 
                                <li>Email a scanned copy or a screenshot of the following documents to <a href="#">depedgentri.cabt2012@gmail.com</a>:
                                    <ol>
                                      <li>PSA (Philippine Statistics Authority) (formerly NSO) Birth Certificate</li>
                                      <li>School Form 9 – Learner’s Progress Report Card (formerly Form 138/Report Card)</li>
                                      <li>Certificate of Good Moral Character	</li>
                                      <li>Parents’ Certificates of Employment/Unemployment (Grade 7 applicants)</li>
                                      <li>Completer’s Certificate (incoming Grade 11) </li>
                                      <li>SHS QVR (Qualified Voucher Recipient) Certificate</li>
                                      <li>ESC Certification Letter (for transferring ESC Grantees and SHS Voucher Program Beneficiaries)</li>
                                    <ol>
                                </li>
                              </ol>
                            </div>
                        ...
                        <div class="tab-pane fade" id="vert-tabs-2" role="tabpanel" aria-labelledby="vert-tabs-2-tab">
                          <div class="card card-outline shadow">
                            ...
                            <div class="card-body text-dark">
                              <p class="lead">I hereby give consent for my personal data and responses entered herein to be processed for the pre-enrollment survey of CABT pursuant to RA 10173 (Data Privacy Act of 2012) and other applicable laws and issuances.</p>
                              <div class="form-check">
                                <div class="custom-control custom-checkbox">
                                  <input type="checkbox" class="custom-control-input" id="save-info">
                                  <label class="custom-control-label" for="save-info">I agree with the privacy policy</label>
                                </div>
                              </div>
                            </div>
                          </div> 
                        ...
                        <div class="tab-pane fade" id="vert-tabs-4" role="tabpanel" aria-labelledby="vert-tabs-4-tab">                             
                          ...
                          <div class="card card-outline shadow">
                            <div class="card-header bg-purple">
                              <h3>Guardian's Profile (if applicable)</h3>
                            </div>
                            <div class="card-body text-dark">
                                <div class="row">
                                  <div class="col-md-3 mb-3">
                                ...
                                <div class="row">
                                  <div class="col-md-4 mb-3">
                                    <label for="firstName">Relationship to the Child</label>
                                    <input type="text" class="form-control" id="firstName" placeholder="" value="" required>
                                    <div class="invalid-feedback">
                                      Valid first name is required.
                                    </div>
                        ...
                        <div class="tab-pane fade" id="vert-tabs-5" role="tabpanel" aria-labelledby="vert-tabs-5-tab">                             
                          <div class="card card-outline shadow">
                            ...
                            <div class="card-body text-dark">
                                <div class="row">
                                  <div class="col-md-7 mb-3">
                                    <label for="firstName">Person to Contact In Case of Emergency</label>
                                    <input type="text" class="form-control" id="firstName" placeholder="" value="" required>
                                    <div class="invalid-feedback">
                                      Valid first name is required.
                                    </div>
                                ...
                                <div class="row">
                                  <div class="col-md-6 mb-3">
                                    <label for="firstName">Relationship to the Learner</label>
                                    <input type="text" class="form-control" id="firstName" placeholder="" value="" required>
                                    <div class="invalid-feedback">
                                      Valid first name is required.
                                    </div>
