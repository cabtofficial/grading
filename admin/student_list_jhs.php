    ...
    <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item has-treeview menu-open">
        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item">
            <a href="../admin/student_list_jhs.php?username='.$_GET['username'].'" class="nav-link active">
              <i class="far fa-circle nav-icon"></i>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-3">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title" id="section1">Grade 7 - Transfiguration</h3>
            </div>
            <div class="card-body">
        ...
        <div class="col-md-3">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title" id="section2">Grade 8 - Assumption</h3>
            </div>
            <div class="card-body">
        ...
        <div class="col-md-3">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title" id="section3">Grade 9 - Coronation</h3>
            </div>
            <div class="card-body">
        ...
        <div class="col-md-3">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title" id="section4">Grade 10 - Holy Trinity</h3>
            </div>
            <div class="card-body">
...
<script>
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../teacher/api/read_student_list.php?section=Grade 7 - Transfiguration",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
                response += "<tr>"+
                "<td><a href='../admin/card_jhs.php?username=<?php echo $_GET['username']; ?>&user_id="+data[user].student_num+"'>"+data[user].last_name+", "+data[user].first_name+"</a></td>"+
                "</tr>";
            }
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../teacher/api/read_student_list.php?section=Grade 8 - Assumption",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../teacher/api/read_student_list.php?section=Grade 9 - Coronation",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../teacher/api/read_student_list.php?section=Grade 10 - Holy Trinity",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
