<?php
  ...
  <nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      <li class="nav-item">
        <a href="../student/index_shs.php?username='.$_GET['username'].'" class="nav-link">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>Track</b> <a class="float-right" id="track">Track</a>
                  </li>
                  <li class="list-group-item">
                    <b>Strand</b> <a class="float-right" id="strand">Strand</a>
                  </li>                    
                </ul>
                      ...
                      <div class="card-body">
                        <div class="col-md-12">
                          <div class="card">
                            <div class="card-header p-2">
                              <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-link active" href="#sem1" data-toggle="tab">1st Semester</a></li>
                                <li class="nav-item"><a class="nav-link" href="#sem2" data-toggle="tab">2nd Semester</a></li>
                              </ul>
                            </div> <!-- /.card-header -->
                            <div class="card-body">
                              <div class="tab-content">
...
<script>
  $(document).ready(function(){
        $.ajax({
            type: "GET",
            url: "../student/api/read_single.php?username=<?php echo $_GET['username']; ?>",
            dataType: 'json',
    ...
    $.ajax({
        type: "GET",
        url: "../student/api/read_grades_shs1.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
          var response="";
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../student/api/read_grades_shs2.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
          var response="";
          for(var user in data){
  ...
  $(document).ready(function(){
        $.ajax({
            type: "GET",
            url: "../student/api/read_grades_sem1.php?username=<?php echo $_GET['username']; ?>",
            dataType: 'json',
            success: function(data) {
    ...
    $.ajax({
        type: "GET",
        url: "../student/api/read_values.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../student/api/read_deportment1_shs.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../student/api/read_deportment2_shs.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../student/api/read_deportment3_shs.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../student/api/read_deportment4_shs.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../student/api/read_deportment.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
          ...
          $.ajax({
              ...
              success: function(data) {
                  ...
                  for(var user in data){
                      ...
                      '<td colspan="1" style="width:10%;padding:3px 0px 3px 0px;">'+data[user].fourth+"</td>"+
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../student/api/read_attendance.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../student/api/read_rank.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../student/api/read_subj_absences.php?username=<?php echo $_GET['username']; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
