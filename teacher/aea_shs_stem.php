        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../teacher/aea_shs_stem.php?username='.$_GET['username'].'" class="nav-link active">
                  <i class="far fa-dot-circle nav-icon"></i>
                  <p>STEM</p>
                </a>
              </li>
...
<script>
  ...
  $(document).ready(function(){
      $.ajax({
          type: "GET",
          url: "../teacher/api/read_subjects.php?section=<?php echo $_SESSION['adviser2']; ?>",
          dataType: 'json',
          success: function(data) {
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../teacher/api/read_aea_q1.php?section=<?php echo $_SESSION["adviser2"]; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../teacher/api/read_aea_q2.php?section=<?php echo $_SESSION["adviser2"]; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
  ...
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../teacher/api/read_aea_q3.php?section=<?php echo $_SESSION["adviser2"]; ?>",
        dataType: 'json',
        success: function(data) {
            var response="";
            for(var user in data){
