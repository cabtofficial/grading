<?php
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active">
      <a href="../teacher/adviser_4.php?username='.$_GET['username'].'">
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for(var user in data){
                ...
                response +="<td style='width:5%;font-size:10px;border: 2px solid black;text-align:center;'><a href='../teacher/index_elem_4.php?username=<?php echo $_GET['username']; ?>&user_id="+data[user].student_num+"'>View Card</a>"+
                "</tr>";
            }
